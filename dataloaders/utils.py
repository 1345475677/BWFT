...
dataset_stats = {
    ...
    #              'std': 0.5,
    #              'size': 32},
    'ImageNet_R': {'mean': (0.0,0.0,0.0),
                 'std': (1.0,1.0,1.0),
                 'size' : 224},
    'ImageNet_100':{'mean': (0.0,0.0,0.0),
                 'std': (1.0,1.0,1.0),
                'size': 224},
    'DomainNet': {'mean': (0.0,0.0,0.0),
                 'std': (1.0,1.0,1.0),
                 'size' : 224},
    'SKIN40': {'mean': (0.5070751592371323, 0.48654887331495095, 0.4409178433670343),
                'std': (0.2673342858792409, 0.25643846291708816, 0.2761504713256834),
                'size': 224},
    'OrganSMNIST': {'mean': (0.5070751592371323, 0.48654887331495095, 0.4409178433670343),
                'std': (0.2673342858792409, 0.25643846291708816, 0.2761504713256834),
                'size': 224},
    'PathMNIST':{'mean': (0.5070751592371323, 0.48654887331495095, 0.4409178433670343),
                'std': (0.2673342858792409, 0.25643846291708816, 0.2761504713256834),
                'size': 224}
    }
